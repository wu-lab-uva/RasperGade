...
library(RasperGade)
#
job.names = c("Result/Empirical/rrn",
              "Result/Empirical/gGC",
              "Result/Empirical/GS",
              "Result/Empirical/N",
              "Result/Empirical/rGC")
...
if(file.exists("Result/Empirical/Bacteria.CV.RDS")){
  all.asr = readRDS("Result/Empirical/Bacteria.CV.RDS")
}else{
  all.asr = list()
  ...
  saveRDS(all.asr,"Result/Empirical/Bacteria.CV.RDS")
}
...
list(do.call(rbind,readRDS("Result/Empirical/Landis.BM.plot.data.RDS"))))
#
...
list(do.call(rbind,readRDS("Result/Empirical/Landis.PEBME.plot.data.RDS"))))
#
